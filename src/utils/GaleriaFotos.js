export const images = [
    ...
    },
    {
      ...
      descricao: "A trama de Yu Yu Hakusho gira em torno de Yusuke Urameshi, um jovem delinquente sem rumo na vida, acostumado a causar confusão na sua escola e vizinhança. Um dia, ele vê um garotinho prestes a ser atropelado e, agindo por instinto, se joga na frente do carro.",
    ...
    },
    {
      ...
      descricao: "Criada por Akira Toryiama, a franquia conta a história de Son Goku, guerreiro que descobre ser parte de um legado de poderosos conquistadores alienígenas - e passa a defender seu planeta adotivo, a Terra, de outros seres igualmente superfortes e capazes de feitos descomunais.",
      temporada: "9 Temporadas"
    },
    {
    ...
    },
    {
      ...
      descricao: "Em Kimetsu no Yaiba, Tanjiro, um bondoso jovem que ganha a vida vendendo carvão descobre que sua família foi massacrada por um demônio. E, para piorar, Nezuko, sua irmã mais nova e única sobrevivente, também acabou transformada em um demônio.",
